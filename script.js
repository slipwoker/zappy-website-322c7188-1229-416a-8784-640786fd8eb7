  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      if (isValid) {
        ...
        // Form can be submitted here or via AJAX
        // contactForm.submit();
      }
    });
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Shailiro by Tania Avigail משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '322c7188-1229-416a-8784-640786fd8eb7',
                    name: data.name || '',
                    email: data.email || '',
